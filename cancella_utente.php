...
<html>
    ...
    <head>
        ...
        <title>Cancellazione utente - Biblioteca Universitaria</title>
    ...
    <!-- fine barra di navigazione -->
        <!-- inizio form res -->
        <div id="formRes">
            <h1>ESITO CANCELLAZIONE UTENTE</h1>
            <?php if($affected_rows > 0) {?>
                <p>Cancellazione utente avvenuta con successo!</p>
                <a href="./menu.html">Menù &#x2934;</a> | <a href="./index.html">Ritorna all HOME</a><br/>
            <?php }
            else { ?>
                <p>OPS :(</p>
                <p>Sembra che qualcosa sia andato storto durante la cancellazione.</p>
                <p>ATTENZIONE!! Se l'utente inserito ha ancora prestiti attivi non è possibile cancellarlo.</p>
                <p><a href="consulta-prestiti.html">Clicca qui</a> per vedere se l'utente ha prestiti attivi.</p>
